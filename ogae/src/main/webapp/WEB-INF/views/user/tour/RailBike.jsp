...
<!--      <div class="image-container"> -->
    <div class="slider-container">
        <div class="slider">
            <div class="slide"><img src="resources/images/tour/가평레일바이크.jpg" alt="이미지 1"></div>
            <div class="slide"><img src="resources/images/tour/가평레일바이크2.jpg" alt="이미지 2"></div>
            <div class="slide"><img src="resources/images/tour/가평레일바이크3.jpg" alt="이미지 3"></div>
        </div>
        </div>
    ...
    <div class="preview-container" id="previewContainer">
        <div class="content" style="white-space: pre-line;">
          <button type="button" class="btn__close">닫기</button>
            <div class="content">
            <h2>Rail Bike</h2>
             <p>멈춰버린 경춘선에 새로운 생명을 불어넣어 레일바이크로 다시 달리고 있습니다. 가을이면 북한강의 가을 단풍의 모습은 그야말로 장관입니다. 사랑하는 사람과 잊지 못할 추억을 만들기에는 충분한 장소입니다.​</p>
        </div>
        </div>
        </div>
...
function makeClickListener(link) {
   ...
   <a href="PetitFrance.do">
    ...
    <a href="JadeGarden.do">
     <div style="width : 150px; height: 100px;" class="image-container">
        <img src="resources/images/tour/제이드가든3.jpg" alt="Image 6" style="border : 2px solid white;">
        <span class="image-caption">제이드가든</span>
    </div>
    </a> &ensp;
    <a href="Jara.do">
     <div style="width : 150px; height: 100px;" class="image-container">
        <img src="resources/images/tour/자라섬3.jpg" alt="Image 7" style="border : 2px solid white;">
