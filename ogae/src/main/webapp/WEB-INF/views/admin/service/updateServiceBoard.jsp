				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<tr>
					  <th class="service_name" width="15%">서비스명</th>
					  	<td><input type="text"	name="service_name" placeholder="서비스 이름을 입력하세요." class="input-box" value="${service.service_name}"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
						<input type="text" id="service_price" name="service_price" placeholder="서비스 가격을 입력하세요" class="input-box" value="${service.service_price}">
						</td>
					</tr>	
					</table>
					<br>
					...
					<tr>
						<td colspan="4">
					 <textarea id="service_info" id="service_info" name="service_info" placeholder="서비스 내용을 입력하세요" class="input-box"  style="text-align: center;" >${service.service_info}</textarea>
				</tr>
				<tr>
